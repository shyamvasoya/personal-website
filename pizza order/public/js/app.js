...
function initAdmin() {
  ...
  function renderItems(items) {
    var parseedItems = Object.values(items);
    return parseedItems.map(function (menuItem) {
...
var addToCart = document.querySelectorAll('.add-to-class'); // its a array fo all button becues of querySelectorAll
...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', pizza).then(function (res) {
    // cartController mathi je req aave te aahi male
    // console.log(res);
    // console.log(res.data); // cartContoller mathi je res male te aahi male
    cartCounter.innerText = res.data.totalQty; // for notifications

    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      type: 'success',
      timeout: 1000,
      text: 'Items added to cart' // progressBar: false, // timeout progressbar na joi ye to
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); // je button per click karo teno data je pizza name thi male 6 te aani pizaa name na variyabal ma save thai jase pen te string form ma hase tene obj ma convert karvo pade tethi aanhi string parse karvi pade 
...
Object(_admin__WEBPACK_IMPORTED_MODULE_2__["default"])(); ///  change perticuler order status  *****************************************
...
updateStatus(order); // socket cilent side work *****************************************
...
__webpack_require__(/*! E:\REAL TIME PIZZA WEB\REAL TIME PIZZA WEB APP\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\REAL TIME PIZZA WEB\REAL TIME PIZZA WEB APP\resources\scss\app.scss */"./resources/scss/app.scss");
